    ...
    updateSpriteLibrary() {
        ...
        this.sprites.forEach((sprite, index) => {
            ...
            deleteBtn.addEventListener('click', (e) => {
                ...
                objectManager.objects = objectManager.objects.filter(o => o.spriteId !== sprite.id);

                if (this.selectedSprite === sprite.id) this.selectedSprite = null;
                if (editor.selectedObject && objectManager.objects.findIndex(o => o.id === editor.selectedObject) === -1) {
